...
class $AssetsImagesSvgGen {
  ...
  /// File path: assets/images/svg/bonfire.svg
  SvgGenImage get bonfire => const SvgGenImage('assets/images/svg/bonfire.svg');

  /// File path: assets/images/svg/card.svg
  SvgGenImage get card => const SvgGenImage('assets/images/svg/card.svg');
